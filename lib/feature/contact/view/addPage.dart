...
import 'package:cntimageriverpod/feature/contact/view/dailog.dart';
...
class addPage extends ConsumerWidget {
  ...
  final bool isEdit;
  final int? index;
  addPage({this.nameText, this.phoneText, this.isEdit = false, this.index});
